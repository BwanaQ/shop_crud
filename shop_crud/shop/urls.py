...
from .views import *
urlpatterns = [
    path('category/', CategoryIndexView.as_view(), name="category-home"),
    path('category/<slug:slug>/', CategoryDetailedView.as_view(), name="category-detail-view"),
    path('category/new/', CategoryCreateView.as_view(),name='category-create-view'),
    ...
    path('product/', ProductListView.as_view(), name="product-home"),
